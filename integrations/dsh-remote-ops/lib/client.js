window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const remoteOpsStyle = document.getElementById(styleId); if (remoteOpsStyle) remoteOpsStyle.textContent += `.dsh-remote-ops__inputCursor{position:absolute;left:12px;bottom:10px;z-index:3;width:2px;height:1.35em;background:var(--dsw-alias-interactive-brand,#4d6bfe);box-shadow:0 0 0 1px color-mix(in srgb,var(--dsw-alias-interactive-brand,#4d6bfe) 18%,transparent);animation:dsh-remote-ops-caret 1s steps(1,end) infinite;pointer-events:none}@keyframes dsh-remote-ops-caret{0%,45%{opacity:1}46%,100%{opacity:0}}`;
    ...
    const empty = { groups: [], environments: [], quickGroups: [], quickCommands: [], sessions: [], events: [], bound: false, pluginName: "dsh-remote-ops", pluginVersion: "0.2.12", update: { currentVersion: "0.2.12", latestVersion: "0.2.12", updateAvailable: false } };
    ...
    function RemoteOpsPanel({ sessionId }) {
      ...
      const terminal = h("section", { className: "dsh-remote-ops__terminal" },
        ...
        activeSession ? h("div", { className: "dsh-remote-ops__screen", onClick: () => terminalInputRef.current?.focus() },
          ...
          terminalReady ? h("span", { className: "dsh-remote-ops__inputCursor", "aria-hidden": true }) : null,
